...
class UserBase(IDBase):
    ...
    role: int = SQLField(0, nullable=False, description="身分組", foreign_key="Permission.role_code")
    class_code: int = SQLField(-1, nullable=False, foreign_key="ClassData.class_code")
